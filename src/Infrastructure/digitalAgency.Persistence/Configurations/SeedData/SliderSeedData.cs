    ...
    public static class SliderSeedData
    {
        public static List<Slider> GetSliders()
        {
            return new List<Slider>
            {
                new Slider
                {
                    Id = Guid.Parse("SLD00001-0001-0001-0001-000000000001"),
                ...
                new Slider
                {
                    Id = Guid.Parse("SLD00001-0001-0001-0001-000000000002"),
                ...
                new Slider
                {
                    Id = Guid.Parse("SLD00001-0001-0001-0001-000000000003"),
